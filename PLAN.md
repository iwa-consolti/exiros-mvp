...
- **3.1 `[AND]`** FusedLocation captura pasiva (`accuracyMeters`) + Room cola local y estado completo del viaje (`tripToken`, snapshot, puntos, cierre pendiente). **Hecho cuando:** se acumulan puntos y la app restaura M3 tras reiniciar proceso/app sin perder el viaje.
